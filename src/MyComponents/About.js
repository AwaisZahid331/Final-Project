        ...
        <div className="container content-section">
          <div className="row">
            ...
            <div className="col-md-6" data-aos="fade-left">
              ...
              <br /> <br />
              <div>
                <h1 style={{ color: "rgb(255, 140, 0)", textAlign: "center" }}>
                  How we do it?
                </h1>
                <p>
                  ...
                  ensuring quality through moderation. We continuously update
                  the platform to meet students' evolving needs and support
              ...
              <div className="mt-4">
                ...
                <p>
                  ...
                  resources. We focus on continuous improvement and user
                  feedback to create an engaging and effective learning
                  environment.
                </p>
              </div>
            </div>
            ...
            >
              <div className="col-md-6">
                <div className="mission-content">
                  ...
                  <p className="mission-text">
                    ...
                    ideas thrive and transformative solutions are born.
              ...
              <div className="col-md-6 mission-image text-center">
                <img
                  ...
                  alt="A business idea lightbulb illustration"
                  className="img-fluid"
                />
              </div>
            </div>
