...
const Footer = () => {
  return (
    <>
      <div>
        <footer
          className="text-lg-start text-white bg-dark "
              ...
              <div className="row" style={{ marginTop: "20px" }}>
                <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                  ...
                  <p>
                    ...
                    where learning becomes a shared experience and success is
                    achieved together.
                  </p>
                </div>
                <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                  ...
                  />
                  <p>
                    <NavLink to="/pastpapers" className="text-white">
                      Past Papers
                    </NavLink>
                  </p>
                  <p>
                ...
                <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                  ...
                  />
                  <p>
                    <i className="bi bi-house-add-fill"></i> Gujrat, Pakistan
                  </p>
                  <p>
                    <i className="bi bi-envelope-arrow-down-fill"></i>{" "}
                    awaistech63@gmail.com
                  </p>
